            ...
            <section id="home" className="bg-gradient-to-r from-purple-500 to-purple-700 text-white py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-lg mb-8">
                        Cung cấp thông tin chi tiết về lá số tử vi, ngày tốt xấu, và nhiều điều bí ẩn trong cuộc sống
                        của bạn.
                    </p>
                    <a
                        href="#cta"
                        className="px-6 py-3 bg-yellow-400 text-purple-700 font-bold rounded hover:bg-yellow-500"
                    >
                        Tìm Hiểu Ngay
                    </a>
                </div>
